package com.htamayo.sbcrashcourse.lendingengine.application.config;

import com.htamayo.sbcrashcourse.lendingengine.domain.event.UserRegisteredEventHandler;
...
public class MessagingConfig {
    ...
    @Bean
    public SimpleMessageListenerContainer container(ConnectionFactory connectionsFactory,
                                                    MessageListenerAdapter messageListenerAdapter){
        SimpleMessageListenerContainer container = new SimpleMessageListenerContainer();
        container.setConnectionFactory(connectionsFactory);
